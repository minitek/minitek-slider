...
$latest_version = MinitekSliderHelper::latestVersion();
...
<div class="alert alert-success text-center mt-0" id="update-box">
  <div class="update-info">
    <div>
      <span><?php echo Text::_('COM_MINITEKSLIDER_DASHBOARD_A_NEW_VERSION_IS_AVAILABLE'); ?></span>
    ...
    <div class="mt-2">
      <a class="button-success btn btn-sm btn-success" href="<?php echo Route::_('index.php?option=com_installer&view=update'); ?>">
        ...
        <?php echo Text::_('COM_MINITEKSLIDER_DASHBOARD_UPDATE_NOW'); ?>
      </a>
    </div>
  </div>
</div>
<?php } else if ($type == 'check') { ?>
    ...
    <div class="update-info">
      <div>
        <?php if ($latest_version == $local_version) { ?>
          <span><?php echo Text::_('COM_MINITEKSLIDER_DASHBOARD_YOU_HAVE_THE_LATEST_VERSION'); ?></span>
        <?php } else { ?>
          <span><?php echo Text::_('COM_MINITEKSLIDER_DASHBOARD_YOU_HAVE_A_DEVELOPMENT_VERSION'); ?></span>
        <?php } ?>
        <span class="badge badge-success"><?php echo $latest_version; ?></span> <span class="badge badge-success">Free</span>
      </div>
    </div>
  ...
  <?php } else { ?>
    <div class="alert alert-danger text-center mt-0" id="update-box">
      <div class="update-info">
        <div>
          <span><?php echo Text::_('COM_MINITEKSLIDER_DASHBOARD_COULD_NOT_FETCH_UPDATE_INFO'); ?></span>
        </div>
      </div>
    </div>
  <?php } ?>
