		...
		<div class="modal-content">
			<div class="modal-header">
				<h3 class="modal-title" id="createModuleLabel">
					<?php echo Text::_('COM_MINITEKSLIDER_MODAL_PUBLISH_WIDGET_IN_MODULE'); ?>
				</h3>
				<button type="button" class="close" data-dismiss="modal" aria-label="<?php echo Text::_('COM_MINITEKSLIDER_MODAL_CLOSE'); ?>">
						...
						<?php } else if ($moduleInstalled && !$isNew) { ?>
							<div class="col-12 col-md-6">
								<div class="text-center">
									...
									<p><?php echo Text::_('COM_MINITEKSLIDER_MODAL_IN_MODULE_POSITION_DESC'); ?></p>
									<button class="button-success btn btn-sm btn-success m-2" data-toggle="modal" data-target="#createModule" onclick="Joomla.submitbutton('widget.createModule')">
										...
										<?php echo Text::_('COM_MINITEKSLIDER_MODAL_CREATE_MODULE'); ?>
									</button>
								</div>
							</div>
							<div class="col-12 col-md-6">
								<div class="text-center">
									<h3 class="m-3"><?php echo Text::_('COM_MINITEKSLIDER_MODAL_LOAD_POSITION_PLUGIN'); ?></h3>
									<p><?php echo Text::_('COM_MINITEKSLIDER_MODAL_LOAD_POSITION_PLUGIN_DESC'); ?></p>
									...
									<div class="alert alert-info" role="alert">
										<p><small><?php echo Text::_('COM_MINITEKSLIDER_MODAL_MODULE_SYNTAX'); ?></small></p>
										<p class="lead">&#123;loadposition minitekslider-<?php echo $this->item->id; ?>&#125;</p>
									</div>
								</div>
							</div>
						<?php } ?>
