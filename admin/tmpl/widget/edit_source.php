		...
		<form action="<?php echo Route::_('index.php?option=com_minitekslider&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="widget-form" class="form-validate">
							...
							<div class="source-tile p-4 text-center">
								...
								<?php if ($source['type'] == 'content') { ?>
									<button class="btn btn-success btn-source mt-3" data-source="content">
										<?php echo Text::_('COM_MINITEKSLIDER_SELECT'); ?>
									</button>
								<?php } else { ?>
									<a class="btn btn-info mt-3" href="https://www.minitek.gr/joomla/extensions/minitek-slider#subscriptionPlans" target="_blank">
										<span class="icon-lock"></span>&nbsp;&nbsp;<?php echo Text::_('COM_MINITEKSLIDER_DASHBOARD_UPGRADE_TO_PRO'); ?>
									</a>
								<?php } ?>
							</div>
						</div>
			...
			<?php } else { ?>
				<div class="text-center">
					<h4 class="m-3"><?php echo Text::_('COM_MINITEKSLIDER_SOURCE_PLUGINS_NOT_INSTALLED'); ?></h4>
					<a href="<?php echo Route::_('index.php?option=com_plugins&view=plugins&filter[search]=Minitek%20Source&filter[folder]=content'); ?>" class="btn btn-info m-3" target="_blank">
						...
						<?php echo Text::_('COM_MINITEKSLIDER_MANAGE_PLUGINS'); ?>
					</a>
					<a href="https://www.minitek.gr/joomla/source-plugins" class="btn btn-success m-3" target="_blank">
						<span class="icon-new" aria-hidden="true"></span>&nbsp;
						<?php echo Text::_('COM_MINITEKSLIDER_ADD_SOURCE_PLUGIN'); ?>
					</a>
				</div>
			<?php } ?>
