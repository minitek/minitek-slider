...
/**
 * Widgets view class for Minitek Slider.
 *
 * @since  4.0.0
 */
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(\JText::_('COM_MINITEKSLIDER_WIDGETS_TITLE'), 'grid');
		...
		if ($user->authorise('core.admin', 'com_minitekslider') || $user->authorise('core.options', 'com_minitekslider'))
		{
			ToolbarHelper::custom('widgets.deleteCroppedImages', 'trash.png', 'trash_f2.png', 'COM_MINITEKSLIDER_DELETE_CROPPED_IMAGES', false);
			$toolbar->preferences('com_minitekslider');
		}

		\JHtmlSidebar::setAction('index.php?option=com_minitekslider&view=widgets');
	}
}
