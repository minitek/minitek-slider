...
/**
 * Widget view class for Minitek Slider.
 *
 * @since  4.0.0
 */
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		\JToolbarHelper::title(
			\JText::_('COM_MINITEKSLIDER_WIDGET_TITLE_' . ($checkedOut ? 'VIEW_WIDGET' : ($isNew ? 'NEW_WIDGET' : 'EDIT_WIDGET'))),
		...
		{
			\JToolbarHelper::modal('createModule', 'icon-ok', \JText::_('COM_MINITEKSLIDER_WIDGET_TOOLBAR_PUBLISH_IN_MODULE'));
		}
	}
}
