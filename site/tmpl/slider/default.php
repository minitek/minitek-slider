...
?><div id="mslider_wrapper_<?php echo $this->widgetID;
							?>" class="mslider-wrapper" style="padding: <?php echo $padding; ?>;">
	<?php

	?><div class="mslider-wrapper-inner 
	<?php
	echo $this->horizontal_padding ? 'mslider_horizontal_padding' : ''; ?>">
		<?php
		...
		?><div id="mslider_<?php echo $this->widgetID;
							...
							<?php
							echo ($this->bullets) ? 'with-bullets' : ''; ?> 
							<?php
							echo ($this->progressbar) ? 'with-progressbar' : ''; ?> 
							<?php
							echo $this->bullets_style . '-bullets'; ?> 
							<?php
							echo $suffix; ?>">
			<?php
		...
		// Progress bar
		if ($this->progressbar) {
		?><div id="mslider_progressbar_<?php echo $this->widgetID; ?>" class="mslider-progressbar 
		<?php
			echo ($this->bullets) ? 'with-bullets' : ''; ?>"></div>
		<?php
		}
		?></div>
</div>
...
// Modal images
if ($this->hoverBox && $this->hoverBoxZoomButton && $this->slider_images) {
?><div class="mslider-modal">
		<?php
		echo HTMLHelper::_(
