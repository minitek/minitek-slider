...
class MinitekSliderLibUtilities
{
  ...
  public static function getSourceID($widgetID)
	{
		$db = JFactory::getDBO();
		$query = ' SELECT * '
			. ' FROM '. $db->quoteName('#__minitek_slider_widgets') . ' '
  ...
  public static function getSourceParams($widgetID)
	{
		$db = JFactory::getDBO();
		$query = ' SELECT * '
			. ' FROM '. $db->quoteName('#__minitek_slider_widgets_source') . ' '
  ...
  public static function decodeJSONParams($json)
	...
	// Get slider_params
  public static function getSliderParams($widgetID)
	{
		$db = JFactory::getDBO();
		$query = ' SELECT * '
			. ' FROM '. $db->quoteName('#__minitek_slider_widgets')
		...
		$slider_params = $result->slider_params;

		return self::decodeJSONParams($slider_params);
  }
